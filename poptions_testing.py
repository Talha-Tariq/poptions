...
# Edit and More comments? What goes in README?
    # what is output and what to do with output?
    # entering existing trades?
    # definition of days_to_expiration and closing days? CALENDAR DAYS!
...
closing_days_array = [21, 21, 21]       # Max calendar days passed until position is closed
trials = 2000       # Number of independent trials

print("Call Credit Spread: ", poptions_numba.callCreditSpread(underlying, sigma, rate, trials, days_to_expiration,
...
# trials = 2000
#
# print("Put Credit Spread: ", poptions_numba.putCreditSpread(underlying, sigma, rate, trials, days_to_expiration,
#                                              closing_days_array, percentage_array, short_strike,
#                                              short_price, long_strike, long_price))
#
# ###############################################################
...
# trials = 2000
# #
# print("Call Debit Spread: ", poptions_numba.callDebitSpread(underlying, sigma, rate, trials, days_to_expiration,
#                                              closing_days_array, percentage_array, short_strike,
#                                              short_price, long_strike, long_price))
#
# ###############################################################
...
# trials = 2000
#
# print("Put Debit Spread: ", poptions_numba.putDebitSpread(underlying, sigma, rate, trials, days_to_expiration,
#                                            closing_days_array, percentage_array, short_strike,
#                                            short_price, long_strike, long_price))
#
# ###############################################################
...
# trials = 2000
#
# print("Short Put: ", poptions_numba.shortPut(underlying, sigma, rate, trials, days_to_expiration,
...
# trials = 2000
#
# print("Short Call: ", poptions_numba.shortCall(underlying, sigma, rate, trials, days_to_expiration,
#                                 closing_days_array, percentage_array, short_strike, short_price))
#
# ###############################################################
#
...
# trials = 2000
#
# print("Long Put: ", poptions_numba.longPut(underlying, sigma, rate, trials, days_to_expiration,
...
# trials = 2000
#
# print("Long Call: ", poptions_numba.longCall(underlying, sigma, rate, trials, days_to_expiration,
#                               closing_days_array, multiple_array, long_strike, long_price))
#
# ###############################################################
#
...
# trials = 2000
#
# print("Covered Call: ", poptions_numba.coveredCall(underlying, sigma, rate, trials, days_to_expiration,
#                                     closing_days_array, percentage_array, short_strike, short_price))
#
# ###############################################################
#
...
#
# print("Iron Condor: ", poptions_numba.ironCondor(underlying, sigma, rate, trials, days_to_expiration,
...
# trials = 2000
#
# print("Short Strangle: ", poptions_numba.shortStrangle(underlying, sigma, rate, trials, days_to_expiration,
